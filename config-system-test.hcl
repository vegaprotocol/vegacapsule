output_dir             = "/Users/daniel/vega/vegacapsule/testnet"
vega_binary_path       = "/Users/daniel/go/bin/vega"
prefix                 = "st-local"
...
EOT
  ...
  wallet "wallet-1" {
    binary = "/Users/daniel/go/bin/vegawallet"
	...
	"app_state": {
	  "assets": {
		...
		"b4f2726571fbe8e33b442dc92ed2d7f0d810e21835b7371a7915a365f07ccd9b": {
			...
			"source": {
				"erc20": {
					"contract_address": "0xBC944ba38753A6fCAdd634Be98379330dbaB3Eb8"
				}
			}
		},
		"VOTE": {
	  ...
	  "network_parameters": {
		...
		"governance.proposal.asset.requiredParticipation": "0.0000000000000000000000000015",
		"governance.proposal.market.minClose": "2s",
		"governance.proposal.market.minEnact": "2s",
		"governance.proposal.market.requiredParticipation": "0.0000000000000000000000000015",
		"governance.proposal.updateMarket.minClose": "2s",
		"governance.proposal.updateMarket.minEnact": "2s",
		"governance.proposal.updateMarket.requiredParticipation": "0.0000000000000000000000000015",
		...
		"governance.proposal.updateNetParam.requiredParticipation": "0.0000000000000000000000000015",
		...
		"reward.asset": "b4f2726571fbe8e33b442dc92ed2d7f0d810e21835b7371a7915a365f07ccd9b",
		...
		"blockchains.ethereumConfig": "{\"chain_id\": \"1440\", \"network_id\": \"1441\", \"collateral_bridge_contract\": { \"address\": \"0x0858D9BD11A4F6Bae8b979402550CA6c6ddB8332\" }, \"staking_bridge_contract\": {\"address\": \"0xE4c9fB5955bAa8a7965D000afdCEFF25cfe0E8a3\"}, \"confirmations\": 1}"

	  },
	  "network_limits": {
		"propose_market_enabled": true,
      		"propose_asset_enabled": true,
      		"propose_market_enabled_from": "2021-08-31T23:59:59Z",
      		"propose_asset_enabled_from": "2021-08-31T23:59:59Z"
	  }
	},
	"consensus_params": {
	  "block": {
